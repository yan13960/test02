									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="role-show.jsp" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/role/deleteRole.do?id=${role.id}" class="btn bg-olive btn-xs">删除角色</a>
												<a href="${pageContext.request.contextPath}/rest/role/findByIdAndPermission.do?roleId=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
